                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-col justify-between">
                          ...
                          <div className="self-end flex items-center">
                            <button className="btn-primary" type="button" onClick={() => updateQuantityOfProduct(cartItem._id, parseInt(cartItem.quantity) - 1)}>-</button>
                            <span className="btn-primary !text-base">{cartItem.quantity}</span>
                            <button className="btn-primary" type="button" onClick={() => updateQuantityOfProduct(cartItem._id, parseInt(cartItem.quantity) + 1)}>+</button>
                          </div>
                        </div>
                      </li>
